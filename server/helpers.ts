...
export const MIME_MAP: Record<string, string> = {
  ...
  // 文本/代码（text/x-* 多为非标准值，但可被浏览器当作文本展示）
  py: 'text/x-python', rb: 'text/x-ruby', go: 'text/x-go', rs: 'text/x-rust',
  java: 'text/x-java-source', kt: 'text/x-kotlin', scala: 'text/x-scala',
  c: 'text/x-c', h: 'text/x-c', cpp: 'text/x-c', hpp: 'text/x-c', cs: 'text/x-csharp',
  php: 'text/x-php', swift: 'text/x-swift',
  sh: 'application/x-sh', bash: 'application/x-sh', zsh: 'text/x-shellscript', ps1: 'text/x-powershell',
  toml: 'application/toml', ini: 'text/plain', cfg: 'text/plain', conf: 'text/plain', env: 'text/plain',
  vue: 'text/x-vue', svelte: 'text/x-svelte', jsx: 'text/jsx', tsx: 'text/tsx',
  mjs: 'text/javascript', cjs: 'text/javascript', mdx: 'text/markdown',
  rlib: 'text/plain',
  // 音视频
